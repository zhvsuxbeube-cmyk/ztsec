...
namespace ZeroTrace_Security_Official
{
    public partial class Form1 : DevExpress.XtraBars.FluentDesignSystem.FluentDesignForm
    {
        ...
        private const int SidebarGroupHeight = 46;
        private const int SidebarItemHeight = 34;
        // Parent context menu (the 4 top-level items) uses a narrower width.
        // Submenus (child flyouts) keep the original wider width for readability.
        private const int ContextMenuWidth = 265;
        private const int ContextSubMenuWidth = 300;
        ...
        public Form1()
        {
            ...
            this.FormClosing += delegate { DisposeUiIconImages(); };
        ...
        private void WriteCiUiValidation()
        {
            ...
            try
            {
                ...
                {
                    writer.WriteLine("STATUS: " + (hierarchyValid && regionsDoNotOverlap && expandedWidthValid && collapsedStateValid && requiredColumnsVisible && connectionRowsValid && sidebarWidthValid && SidebarAccentColor.ToArgb() == UiTheme.AccentColor.ToArgb() && selectedAccentProbeReady ? "PASS" : "FAIL"));
        ...
        private void SetupGridControl()
        {
            ...
            gridView.RowStyle += (sender, args) =>
            {
                if (args.RowHandle >= 0 && gridView.IsRowSelected(args.RowHandle))
                {
                    ...
                    args.Appearance.BackColor = ColorTranslator.FromHtml("#1E2C3C");
    ...
    catch (Exception ex)
    {
        ...
        protected override void OnDpiChanged(DpiChangedEventArgs e)
        {
            ...
            // Regenerate the small bitmap navigation icons at the new DPI so they
            // remain crisp instead of being bitmap-scaled by Windows.
            ApplySidebarIcons();
            Invalidate(true);
        }
        ...
        private void ConfigureSidebarGroupAppearance(DevExpress.XtraBars.Navigation.AccordionControlElement group)
        {
            ...
            Font groupFont = new Font("Segoe UI Semibold", 10.5F, FontStyle.Bold, GraphicsUnit.Point);
        ...
        private void ConfigureSidebarItemAppearance(DevExpress.XtraBars.Navigation.AccordionControlElement group)
        {
            ...
            foreach (DevExpress.XtraBars.Navigation.AccordionControlElement child in group.Elements)
            {
                ...
                child.Appearance.Normal.Font = new Font("Segoe UI", 9.25F, FontStyle.Regular, GraphicsUnit.Point);
                ...
                child.Appearance.Hovered.Font = new Font("Segoe UI", 9.25F, FontStyle.Regular, GraphicsUnit.Point);
                ...
                child.Appearance.Pressed.Font = new Font("Segoe UI", 9.25F, FontStyle.Regular, GraphicsUnit.Point);
        ...
        private void AccordionControl1_CustomDrawElement(object sender, DevExpress.XtraBars.Navigation.CustomDrawElementEventArgs e)
        {
            ...
            if (e.Element.Style == DevExpress.XtraBars.Navigation.ElementStyle.Group)
            {
                ...
                e.ObjectInfo.PaintAppearance.Font = new Font("Segoe UI Semibold", 10.5F, FontStyle.Bold, GraphicsUnit.Point);
            ...
            if (e.Element.Style == DevExpress.XtraBars.Navigation.ElementStyle.Item && e.Element == accordionControl1.SelectedElement)
            {
                e.Handled = true;
                Rectangle selectedBounds = new Rectangle(
                    lineLeft,
                    header.Top,
                    Math.Max(0, lineRight - lineLeft),
                    header.Height);
                e.Cache.FillRectangle(SidebarAccentColor, selectedBounds);
                e.ObjectInfo.PaintAppearance.ForeColor = Color.White;
                e.ObjectInfo.PaintAppearance.Font = new Font("Segoe UI", 9.25F, FontStyle.Regular, GraphicsUnit.Point);
                e.ObjectInfo.PaintAppearance.Options.UseForeColor = true;
                e.ObjectInfo.PaintAppearance.Options.UseFont = true;
                e.DrawImage();
                e.DrawText();
        ...
        private DevExpress.XtraBars.BarSubItem CreateConnectionMenuGroup(string text, string iconFileName)
        {
            ...
            item.PopupMinWidth = ContextSubMenuWidth;
